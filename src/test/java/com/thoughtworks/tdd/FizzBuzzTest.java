...
public class FizzBuzzTest {
    ...
    @Test
    public void should_return_fizzbuzz_when_student_is_30(){
        //given
        int student =30;
        FizzBuzz fizzBuzz =new FizzBuzz();
        //when
    ...
    @Test
    public void should_return_fizzwhizz_when_student_is_42(){
        //given
        int student =42;
        FizzBuzz fizzBuzz =new FizzBuzz();
        //when
    ...
    @Test
    public void should_return_buzzwhizz_when_student_is_70(){
        //given
        int student =70;
        FizzBuzz fizzBuzz =new FizzBuzz();
        //when
